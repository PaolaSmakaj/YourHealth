...
public class PersonaImpl implements Persona, Serializable{
    ...
    protected PersonaImpl(final String nome, final String cognome, final Sesso sesso, final String luogonascita, final LocalDate datanascita) {
    	this.nome = nome;
    ...
    public static class Builder {
        ...
        public Persona build() throws IllegalArgumentException {
        	if (this.nome1.isEmpty() || this.cognome1.isEmpty() || this.luogonascita1.isEmpty() || this.datanascita1 == null) { 
