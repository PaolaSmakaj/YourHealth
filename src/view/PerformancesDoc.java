...
public class PerformancesDoc extends JFrame{
	...
	public PerformancesDoc(int tesserino) {
		
        try {
        	
			ArrayList<Prestazione> list = AccountDottore.listaPrestazioniDottore(tesserino);
